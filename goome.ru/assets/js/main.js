...
!function (a, b) {
  ...
  }, r.isArray = Array.isArray, r.parseJSON = JSON.parse, r.nodeName = B, "function" == "function" && __webpack_require__(99) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = (function () {
    return r;
  }).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
...
!function (i) {
  "use strict";
   true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(31)], __WEBPACK_AMD_DEFINE_FACTORY__ = (i),
...
!function (a) {
  ...
  return function (a, b, c, d) {
    function e(a) {
      ...
      }, hook: null, mock: !1, version: { major: 1, minor: 5, patch: 1 }, debug: !1, timestamp: !0, pauseAll: function pauseAll(a) {
            ...
            b && o.each(b[1], function (c, e) {
              var f = v === d ? "" : v;if (!0 !== f && b[2].queue !== f && (v !== d || !1 !== b[2].queue)) return !0;o.each(r, function (c, d) {
                if (d === e) if ((!0 === v || u.isString(v)) && (o.each(o.queue(d, u.isString(v) ? v : ""), function (a, b) {
                  ...
                  var h = g(d);h && h.tweensContainer && !1 !== f && o.each(h.tweensContainer, function (a, b) {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(31), __webpack_require__(31), __webpack_require__(40)(module)))
...
console.log('here');
function initMap() {
    // var uluru2 = {lat: 50.386483, lng: 30.464909};
    var map = new google.maps.Map(document.getElementById('map_contacts'), {
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios_index__ = __webpack_require__(12);
    ...
    function getProductsFromFavorites() {
        ...
        if (productsInFavorites != null) {
            ...
            for (var y = 0; y < productsInFavorites.length; y++) {
                ...
                var productString = '<div class="basket_window_block"><div data-i="' + y + '" class="wish_window_block_close"></div>' + '<a href="' + productsInFavorites[y].url + '" class="basket_window_name">' + productsInFavorites[y].name + '</a><div class="col-md-3 col-sm-3 fix col-xs-3">' + '<img class="basket_window_product" src="' + productsInFavorites[y].image + '" alt=""></div><div class="col-md-8 col-sm-8 col-xs-8"><div class="basket_window_price">' + productsInFavorites[y].price + ' руб</div></div></div>';
    ...
    function showProductsFromFavorites() {
        ...
        if (productsInFavorites != null) {
            ...
            for (var y = 0; y < productsInFavorites.length; y++) {
                ...
                var wishString = '<div class="col-md-3 col-sm-3 wish_block col-xs-12"><a href="' + productsInFavorites[y].url + '" class="product_block"><div class="wish_image"><img src="' + productsInFavorites[y].image + '" alt=""></div><p class="wish_text">' + productsInFavorites[y].name + '</p><div class="wish_price"><p>' + productsInFavorites[y].price + ' руб.</p></div></a><div class="wish_btn">Купить</div><img data-i="' + y + '" class="wish_delete" src="assets/img/garbage.png" alt=""</div>';var productDiv = $(productString);
