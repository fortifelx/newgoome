        ...
        <div class="row">
            <div class="col-2">
                <figure class="figure new_product_ilu">
                    ...
                    <img v-show="!value.img" src="/assets/iconic/svg/aperture.svg"
            ...
            <div class="col-6">
                <div class="input-group mb-3">
                    ...
                    <input type="text" ref="shopsName" :value="value.name" @input="sendData()" class="form-control" placeholder="Название" aria-label="Название" aria-describedby="basic-addonvideo">
                </div>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="basic-adddonvideo">Адрес</span>
                    </div>
                    <input type="text" ref="shopsAddress" :value="value.address" @input="sendData()" class="form-control" placeholder="Адрес" aria-label="Адрес" aria-describedby="basic-adddonvideo">
                </div>
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">Описание</span>
                    </div>
                    <textarea ref="shopsDescription" :value="value.description" @input="sendData()" class="form-control" aria-label="With textarea"></textarea>
                </div>
            </div>
            <div class="col-3">
